        ...
        <View style={[isSelf ? styles.right : styles.left]}>
          <View
            style={[
              ...
              loading
                ? {borderColor: isSelf ? voiceRightLoadingColor : voiceLeftLoadingColor}
          ...
          <View
            ...
            <View>
              <TouchableOpacity
                ...
                style={[
                  styles.voiceArea,
                  isSelf ? styles.voiceAreaRight : styles.voiceAreaLeft,
                  loading
                    ? {
                ...
                <View
                  style={[
                    {width: 40 + (message.content.length > 1 ? message.content.length * 2 : 0)},
                    {maxWidth: width - 160},
            ...
            <View style={{justifyContent: 'flex-end'}}>
              <Text
                style={[
                  ...
                  isSelf ? {marginRight: 4} : {marginLeft: 4},
                ]}>
