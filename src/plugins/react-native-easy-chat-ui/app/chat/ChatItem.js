    ...
    switch (type) {
      ...
      case 'location':
        if (this.props.renderLocationMessage === undefined) {
          ...
          return this.props.renderLocationMessage({
            isOpen,
            isSelf,
            message,
            index: parseInt(rowId),
      ...
      case 'videoCall':
        if (this.props.renderVideoCallMessage === undefined) {
          ...
          return this.props.renderVideoCallMessage({
            isOpen,
            isSelf,
            message,
            index: parseInt(rowId),
      ...
      case 'voiceCall':
        if (this.props.renderVoiceCallMessage === undefined) {
          ...
          return this.props.renderVoiceCallMessage({
            isOpen,
            isSelf,
            message,
            index: parseInt(rowId),
      ...
      case 'redEnvelope':
        if (this.props.renderRedEnvelopeMessage === undefined) {
          ...
          return this.props.renderRedEnvelopeMessage({
            isOpen,
            isSelf,
            message,
            index: parseInt(rowId),
