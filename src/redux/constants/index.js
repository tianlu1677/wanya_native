...
// 未完成认证用户信息
export const UPDATE_SOCIAL_TOKEN = 'UPDATE_SOCIAL_TOKEN';
export const UPDATE_SOCIAL_ACCOUNT = 'UPDATE_SOCIAL_ACCOUNT';

// 公共数据
export const UPDATE_TOTAL_LABEL_LIST = 'UPDATE_TOTAL_LABEL_LIST'; //标签数据
export const TOTAL_LABEL_LIST = 'TOTAL_LABEL_LIST';
...
export const ACCOUNT_SAVE_TOKEN = 'ACCOUNT_SAVE_TOKEN';
...
export const CHANGE_COMMENT_VISIBLE = 'CHANGE_COMMENT_VISIBLE'; // 全局评论框
